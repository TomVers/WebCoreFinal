...
var menu = document.querySelector('.button-menu--icon-bar');
var sidebar = document.querySelector('.sidebar');
var sidebarClose = document.querySelector('.top-menu__button--close');
...
var call = document.querySelectorAll('.button-menu--icon-call');
var modalCall = document.querySelector('.modal-call');
var modalCallClose = document.querySelector('.modal-call__button-close');
...
var feedback = document.querySelectorAll('.button-menu--icon-chat');
var modalFeedback = document.querySelector('.modal-feedback');
var modalFeedbackClose = document.querySelector('.modal-feedback__button-close');

for (var _i = 0; _i < feedback.length; _i++) {
  feedback[_i].addEventListener('click', function () {
    overlay.classList.add('overlay--active');
...
function mobileSlider() {
  if (window.innerWidth < 768 && slider.dataset.mobile == 'false') {
    swiper = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_1___default.a(slider, {
      slidesPerView: 1,
      spaceBetween: 16,
      pagination: {
...
var allBrands = document.querySelector('.brands__all');
var brands = document.querySelector('.brands__container');
var brandsIcon = document.querySelector('.brands__all--icon');
...
var sliderTwo = document.querySelector('.swiper-container-two');
var swiperTwo;

function mobileSliderTwo() {
  if (window.innerWidth < 768 && sliderTwo.dataset.mobile == 'false') {
    swiperTwo = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_1___default.a(sliderTwo, {
      slidesPerView: 1,
      spaceBetween: 16,
      pagination: {
...
var allGadgets = document.querySelector('.gadgets__all');
var gadgets = document.querySelector('.gadgets__container');
var gadgetsIcon = document.querySelector('.gadgets__all_icon');
allGadgets.addEventListener('click', function () {
...
var sliderThree = document.querySelector('.swiper-container-three');
var swiperThree;

function mobileSliderThree() {
  if (window.innerWidth < 768 && sliderThree.dataset.mobile == 'false') {
    swiperThree = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_1___default.a(sliderThree, {
      slidesPerView: 1,
      spaceBetween: 16,
      pagination: {
...
var postButton = document.querySelector('.post__button');
var post = document.querySelector('.post__text');
var postIcon = document.querySelector('.post__button--icon');
